...
const styles = {
  ...
  staticMenuTitle: { fontSize: "24px", fontWeight: "700", marginBottom: "15px", color: "#1a472a" },
  staticMenuDesc: { fontSize: "14px", color: "#555", lineHeight: "1.5", margin: 0 },
  card: {
  ...
  return (
    <div style={styles.app}>
      ...
      <main style={styles.main}>
        {activeTab === "menu" && (
          <div style={styles.homeMenuWall}>
            <div style={styles.staticMenuGrid}>
              <div style={styles.staticMenuItem} onClick={() => setActiveTab("analysis")}><h3 style={styles.staticMenuTitle}>🔬 Analysis</h3><p style={styles.staticMenuDesc}>Analyze soil, weather, and farm conditions to determine crop compatibility and optimize farming strategies.</p></div>
              <div style={styles.staticMenuItem} onClick={() => setActiveTab("ml")}><h3 style={styles.staticMenuTitle}>🤖 ML Model</h3><p style={styles.staticMenuDesc}>Use machine learning to predict the best fertilizers based on soil nutrients, crop type, and environmental factors.</p></div>
              <div style={styles.staticMenuItem} onClick={() => setActiveTab("analytics")}><h3 style={styles.staticMenuTitle}>📈 Analytics</h3><p style={styles.staticMenuDesc}>View historical data, performance trends, and insights to improve long-term agricultural productivity.</p></div>
              <div style={styles.staticMenuItem} onClick={() => setActiveTab("chat")}><h3 style={styles.staticMenuTitle}>💬 Chatbot</h3><p style={styles.staticMenuDesc}>Interact with AI to get real-time farming advice, troubleshooting, and recommendations.</p></div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'ml' && (<div style={styles.card}><h2 style={styles.cardTitle}>ML Model Analysis</h2><MLModel /></div>)}
        ...
        {activeTab === 'chat' && (<div style={styles.card}><h2 style={styles.cardTitle}>Farm Chatbot</h2><Chatbot /></div>)}
      </main>
    </div>
  );
}
